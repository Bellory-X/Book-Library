...
public class PgSubscription extends TableImpl<PgSubscriptionRecord> {
     ...
     */
    public <U> SelectField<U> mapping(Function14<? super Long, ? super Long, ? super Object, ? super String, ? super Long, ? super Boolean, ? super Boolean, ? super Boolean, ? super String, ? super Boolean, ? super String, ? super String, ? super String, ? super String[], ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function14<? super Long, ? super Long, ? super Object, ? super String, ? super Long, ? super Boolean, ? super Boolean, ? super Boolean, ? super String, ? super Boolean, ? super String, ? super String, ? super String, ? super String[], ? extends U> from) {
