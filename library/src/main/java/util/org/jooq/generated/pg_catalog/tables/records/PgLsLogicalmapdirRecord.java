...
public class PgLsLogicalmapdirRecord extends TableRecordImpl<PgLsLogicalmapdirRecord> implements Record3<String, Long, OffsetDateTime> {
    ...
    public Field<String> field1() {
        return PgLsLogicalmapdir.PG_LS_LOGICALMAPDIR.NAME;
    }

    @Override
    public Field<Long> field2() {
        return PgLsLogicalmapdir.PG_LS_LOGICALMAPDIR.SIZE;
    }

    @Override
    public Field<OffsetDateTime> field3() {
        return PgLsLogicalmapdir.PG_LS_LOGICALMAPDIR.MODIFICATION;
    }
    ...
    @Override
    public PgLsLogicalmapdirRecord value1(String value) {
        setName(value);
        return this;
    }

    @Override
    public PgLsLogicalmapdirRecord value2(Long value) {
        setSize(value);
        return this;
    }

    @Override
    public PgLsLogicalmapdirRecord value3(OffsetDateTime value) {
        setModification(value);
        return this;
    }

    @Override
    public PgLsLogicalmapdirRecord values(String value1, Long value2, OffsetDateTime value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
